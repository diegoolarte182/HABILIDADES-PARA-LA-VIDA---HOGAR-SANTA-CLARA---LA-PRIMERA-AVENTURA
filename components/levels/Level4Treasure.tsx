...
export const Level4Treasure: React.FC<Level4Props> = ({ data, onChange, onSubmit, isSubmitting }) => {
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-amber-50 p-6 rounded-2xl border border-amber-100 text-center">
             <h3 className="text-xl font-bold text-amber-800 mb-2">¿Cuál es tu mayor sueño o meta en la vida?</h3>
             <p className="text-amber-700/70 text-sm mb-4">No hay límites. Escribe lo que tu corazón desea.</p>
        ...
        <div className="pt-4">
          <Button fullWidth onClick={onSubmit} disabled={!isValid || isSubmitting}>
