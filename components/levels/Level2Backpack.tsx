...
const YesNoQuestion: React.FC<{
  ...
  return (
    <div className="bg-purple-50/50 p-4 rounded-2xl border border-purple-100">
      <label className="block text-gray-800 font-semibold mb-3">{number}. {label}</label>
    ...
    >
      <div className="space-y-6">
        ...
        <YesNoQuestion
          ...
          descPlaceholder="¿Cuál tratamiento médico recibes?"
        />
        ...
        <YesNoQuestion
          ...
          descPlaceholder="¿Qué tipo de acompañamiento o tratamiento?"
        />
        ...
        <YesNoQuestion
          ...
          descPlaceholder="¿Qué tipo de apoyo o tratamiento recibiste?"
        />
